...
(function (root, factory) {
  ...
  var CSS = [
    ...
    '.eaves-panel{display:none;position:absolute;bottom:48px;right:0;min-width:230px;max-width:300px;max-height:360px;overflow-y:auto;background:#18181b;color:#f4f4f5;border-radius:10px;box-shadow:0 8px 30px rgba(0,0,0,.35);padding:8px;}',
    '.eaves-root[data-position="top-right"] .eaves-panel,.eaves-root[data-position="top-left"] .eaves-panel{bottom:auto;top:48px;}',
    '.eaves-root[data-position="bottom-left"] .eaves-panel,.eaves-root[data-position="top-left"] .eaves-panel{right:auto;left:0;}',
    '.eaves-root.eaves-open .eaves-panel{display:block;}',
    '.eaves-header{font-size:11px;text-transform:uppercase;letter-spacing:.04em;color:#a1a1aa;padding:6px 8px 4px;}',
    '.eaves-item{display:block;width:100%;text-align:left;background:none;border:none;color:#f4f4f5;padding:7px 8px;border-radius:6px;cursor:pointer;font-size:13px;font-family:inherit;}',
