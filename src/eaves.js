...
(function (root, factory) {
  ...
  var CSS = [
    ...
    '.eaves-bar{display:flex;align-items:stretch;height:40px;box-shadow:0 2px 10px rgba(0,0,0,.25);}',
    '.eaves-grip{width:20px;flex:none;background:#2c2c2c;border-radius:8px 0 0 8px;display:flex;align-items:center;justify-content:center;color:#b1b1b1;cursor:grab;touch-action:none;}',
    '.eaves-grip:active{cursor:grabbing;}',
    '.eaves-grip svg{width:16px;height:16px;}',
    '.eaves-bar-mid{background:#2c2c2c;display:flex;align-items:center;padding:0 4px;}',
    ...
    '.eaves-bar-close{width:24px;flex:none;background:#2c2c2c;border-radius:0 8px 8px 0;display:flex;align-items:center;justify-content:center;color:#b1b1b1;cursor:pointer;transition:color .15s ease;}',
